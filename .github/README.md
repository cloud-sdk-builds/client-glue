...
[`@aws-sdk/client-glue`](https://www.npmjs.com/package/@aws-sdk/client-glue/v/3.37.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-glue@3.37.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4PRVP0EuA9vfGN6IO2EtMug2h5odr6GHSLN/w6Ydxs/MGz8TKS1mtoKemtDrILZN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-glue": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-glue@3.37.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-glue@3.37.0/index.min.mjs": "sha384-4PRVP0EuA9vfGN6IO2EtMug2h5odr6GHSLN/w6Ydxs/MGz8TKS1mtoKemtDrILZN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-glue/blob/refs/tags/3.37.0/LICENSE
```
