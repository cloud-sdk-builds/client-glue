...
[`@aws-sdk/client-glue`](https://www.npmjs.com/package/@aws-sdk/client-glue/v/3.9.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-glue@3.9.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DRXDrbSASccUXZudSE+9rulOM0+Nt+HUn0L3mX+rdv5TWlhjab7JyrDHfLmY+qSD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-glue": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-glue@3.9.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-glue@3.9.0/index.min.mjs": "sha384-DRXDrbSASccUXZudSE+9rulOM0+Nt+HUn0L3mX+rdv5TWlhjab7JyrDHfLmY+qSD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-glue/blob/refs/tags/3.9.0/LICENSE
```
